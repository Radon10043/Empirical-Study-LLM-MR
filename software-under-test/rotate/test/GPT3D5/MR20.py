...
class TestingClass(unittest.TestCase):
    ...
    def test20(self, img: np.array, angle: float):
        """Metamorphic Relation 20: Rotating the image by angle A and then translating the resulting image is equivalent to translating the original image and then rotating the result by angle A."""
        # Get source output
