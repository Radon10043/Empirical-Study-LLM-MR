...
class TestingClass(unittest.TestCase):
    ...
    def test42(self, job_list: list):
        """Metamorphic Relation 42: The output of adding a new process and then upgrading the priority of a process is the same as just upgrading the priority of the process without adding any process."""
        # Get source output
        ...
        follow_op = [SCHEDULE_OPERATIONS["UPGRADE_PRIO"], PRIORITY_LEVEL["HIGH"], "0.99999", SCHEDULE_OPERATIONS["FLUSH"]]
