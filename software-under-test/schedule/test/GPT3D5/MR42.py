...
class TestingClass(unittest.TestCase):
    ...
    def test42(self, job_list: list):
        """Metamorphic Relation 42: If all jobs are unblocked and then a new job is added, the resulting output should be different from the original output."""
        # Get source output
        source_op = [SCHEDULE_OPERATIONS["UNBLOCK"], SCHEDULE_OPERATIONS["UNBLOCK"], SCHEDULE_OPERATIONS["UNBLOCK"],
        ...
        # Construct follow-up input to add a job after unblocking all jobs
