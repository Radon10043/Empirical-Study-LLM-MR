...
class TestingClass(unittest.TestCase):
    ...
    def test37(self, job_list: list):
        """Metamorphic Relation 37: The output of upgrading the priority of a process and then adding a new process has the same output as adding a new process and then upgrading its priority."""
        # Get source output
