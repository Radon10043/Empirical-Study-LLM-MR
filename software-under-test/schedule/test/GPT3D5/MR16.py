...
class TestingClass(unittest.TestCase):
    ...
    def test16(self, job_list: list):
        """Metamorphic Relation 16: The output of unblocking a process is the same as not performing any unblocking at all."""
        # Get source output
        source_op = [SCHEDULE_OPERATIONS["NEW_JOB"], PRIORITY_LEVEL["HIGH"], SCHEDULE_OPERATIONS["UNBLOCK"], "0", SCHEDULE_OPERATIONS["FLUSH"]]
