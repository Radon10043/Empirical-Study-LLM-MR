...
class TestingClass(unittest.TestCase):
    ...
    def test33(self, job_list: list):
        """Metamorphic Relation 33: The output of adding a new process and then blocking and unblocking it has the same output as just adding the process without blocking and unblocking."""
        # Get source output
