...
class TestingClass(unittest.TestCase):
    ...
    def test11(self, job_list: list):
        """Metamorphic Relation 11: The output of upgrading the priority of a process and then flushing all processes is the same as flushing all processes and then upgrading the priority of a process."""
        # Get source output
        ...
        follow_op = [SCHEDULE_OPERATIONS["FLUSH"], SCHEDULE_OPERATIONS["NEW_JOB"], PRIORITY_LEVEL["HIGH"], SCHEDULE_OPERATIONS["UPGRADE_PRIO"], PRIORITY_LEVEL["HIGH"], "0.99999"]
