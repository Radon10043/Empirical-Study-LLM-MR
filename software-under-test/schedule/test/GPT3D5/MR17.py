...
class TestingClass(unittest.TestCase):
    ...
    def test17(self, job_list: list):
        """Metamorphic Relation 17: If a job with the highest priority is blocked and then unblocked, the resulting output should be the same as the original output."""
        # Get source output
