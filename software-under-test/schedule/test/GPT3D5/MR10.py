...
class TestingClass(unittest.TestCase):
    ...
    def test10(self, job_list: list):
        """Metamorphic Relation 10: The output of adding a new process and then flushing all processes is the same as flushing all processes and then adding a new process."""
        # Get source output
