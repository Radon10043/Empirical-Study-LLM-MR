...
class TestingClass(unittest.TestCase):
    ...
    def test23(self, job_list: list):
        """Metamorphic Relation 23: The output of blocking a process and then finishing all processes is the same as finishing all processes and then blocking the same process."""
        # Get source output
