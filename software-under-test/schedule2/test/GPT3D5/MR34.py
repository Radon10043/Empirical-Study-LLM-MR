...
class TestingClass(unittest.TestCase):
    ...
    def test34(self, job_list: list):
        """Metamorphic Relation 34: If a job with the highest priority is upgraded to an even higher priority, the execution order remains unchanged."""
        # Get source output
        source_op = [SCHEDULE_OPERATIONS["UPGRADE_PRIO"], PRIORITY_LEVEL["HIGH"], SCHEDULE_OPERATIONS["FLUSH"]]
