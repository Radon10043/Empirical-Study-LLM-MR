...
class TestingClass(unittest.TestCase):
    ...
    def test_metamorphic_relation_6(self, job_list: list):
        """Metamorphic Relation 6: If a new job with a specific priority is added and then the current process is finished, it will have the same result as if the current process is finished without adding a new job."""
        # Get source output
