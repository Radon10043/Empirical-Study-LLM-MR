...
class TestingClass(unittest.TestCase):
    ...
    def test_metamorphic_relation_19(self, job_list: list):
        """Metamorphic Relation 19: If a new job is added, then the current process is finished, and the scheduler state is flushed, it will have the same result as directly flushing the scheduler state without adding the new job or finishing the process."""
        # Get source output
