...
class TestingClass(unittest.TestCase):
    ...
    def test_metamorphic_relation_8(self, job_list: list):
        """Metamorphic Relation 8: The order of adding new jobs with different priorities into the scheduler followed by the 'FLUSH' operation should not affect the final output."""
        # Get source output
