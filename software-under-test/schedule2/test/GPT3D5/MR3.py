...
class TestingClass(unittest.TestCase):
    ...
    def test_metamorphic_relation_3(self, job_list: list):
        """Metamorphic Relation 3: The result of flushing all processes and then adding a new job with a specific priority will be the same as adding the new job first and then flushing all processes."""
        # Get source output
