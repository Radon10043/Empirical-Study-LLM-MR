...
class TestingClass(unittest.TestCase):
    ...
    def test_metamorphic_relation_15(self, job_list: list):
        """Metamorphic Relation 15: If a new job is added with a specific priority, and then the quantum expires for the current process, it will have the same result as expiring the quantum first and then adding the new job."""
        # Get source output
