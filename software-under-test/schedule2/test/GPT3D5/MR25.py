...
class TestingClass(unittest.TestCase):
    ...
    def test25(self, job_list: list):
        """Metamorphic Relation 25: If the time quantum is expired for each job, the execution order remains the same."""
        # Get source output
        source_op = [SCHEDULE_OPERATIONS["QUANTUM_EXPIRE"]] * len(job_list) + [SCHEDULE_OPERATIONS["FLUSH"]]
