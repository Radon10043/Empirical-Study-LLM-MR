...
class TestingClass(unittest.TestCase):
    ...
    def test_metamorphic_relation_26(self, job_list: list):
        """Metamorphic Relation 26: If a new job is added and then the current process is finished, it will have the same result as finishing the process first and then adding the new job."""
        # Get source output
