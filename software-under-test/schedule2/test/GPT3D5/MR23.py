...
class TestingClass(unittest.TestCase):
    ...
    def test_metamorphic_relation_23(self, job_list: list):
        """Metamorphic Relation 23: The result of adding a new job with specific priority followed by expiring the quantum for the current process will be the same as expiring the quantum first and then adding the new job."""
        # Get source output
