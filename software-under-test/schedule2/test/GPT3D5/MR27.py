...
class TestingClass(unittest.TestCase):
    ...
    def test_metamorphic_relation_27(self, job_list: list):
        """Metamorphic Relation 27: If a process is blocked and then the quantum expires for the current process, it will have the same result as expiring the quantum first and then moving the process to the blocked queue."""
        # Get source output
