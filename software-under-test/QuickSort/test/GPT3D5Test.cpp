...
// fixed
/**
 * @brief Metamorphic Relation 4: Appending duplicate elements to the input array, the output array will have the same relative order as the source output, with
 * the duplicates appearing after their original counterparts.
 */
TEST_P(QuickSortParamTest, MR4) {
    ...
    /* Verification */
    vector<int> new_source_out;
    for (const auto &elem : source_out) {
        new_source_out.push_back(elem);
        new_source_out.push_back(elem);
    }
    EXPECT_EQ(follow_out, new_source_out);
}

/**
 * @brief Metamorphic Relation 5: Replacing all elements with the maximum value in the input array, the output will have every element equal to the maximum
 * value, as the array will be sorted.
 */
...
// fixed
/**
 * @brief Metamorphic Relation 6: Appending the input array with an increasing sequence, the output array will be the same as the source output with the
 * increasing sequence appended at the end.
 */
...
/**
 * @brief Metamorphic Relation 8: Adding a constant to each element in the input array, then each element of the output array will be larger by the constant
 * than the element at the same location of the source output.
 */
...
/**
 * @brief Metamorphic Relation 10: Multiplying each element in the input array by a positive constant c, the output array will be in ascending order, with each
 * element c times larger than the corresponding element of the source output.
 */
...
/**
 * @brief Metamorphic Relation 11: Multiplying each element in the input array by a negative constant c, the output array will be sorted in descending order,
 * with each element c times smaller than the corresponding element of the source output.
 */
...
/**
 * @brief Metamorphic Relation 14: Appending a decreasing sequence to the input array, the output array will be sorted in ascending order, with the decreasing
...
/**
 * @brief Metamorphic Relation 16: Swapping two random elements in the input array, the output array will have the same relative order as the source output,
 * with the two elements swapped.
 */
...
/**
 * @brief Metamorphic Relation 18: Appending the input array with a constant value, the output array will have the same relative order as the source output,
 * with the appended value at the end.
 */
...
/**
 * @brief Metamorphic Relation 19: Applying a random permutation to the input array, the output array will have the same relative order as the source output,
 * with the elements permuted accordingly.
 */
...
/**
 * @brief Metamorphic Relation 22: Taking the absolute value of each element in the input array, the output array will have the same relative order as the
 * source output, as the sorting is not affected by the element signs.
 */
...
/**
 * @brief Metamorphic Relation 23: Shifting all elements in the input array by a constant value, the output array will have the same relative order as the
 * source output, just shifted.
 */
...
/**
 * @brief Metamorphic Relation 24: Appending the input array with a decreasing sequence, the output array will be sorted in ascending order, with the decreasing
 * sequence appended at the end.
 */
...
// fixed
/**
 * @brief Metamorphic Relation 25: Multiplying each element in the input array by a constant and then adding another constant to each element, the output array
...
/**
 * @brief Metamorphic Relation 26: Replacing each even-indexed element in the input array with a constant, the output array will have the same relative order as
 * the source output, with the modified elements.
 */
...
// fixed
/**
 * @brief Metamorphic Relation 28: Appending the input array with a constant value, the output array will have the same relative order as the source output,
 * with the appended value at the end.
 */
TEST_P(QuickSortParamTest, MR28) {
    ...
    /* Verification */
    source_out.push_back(append_value);
    EXPECT_EQ(follow_out, source_out);
}

// fixed
/**
 * @brief Metamorphic Relation 29: Repeating the input array multiple times, the output array will have the same relative order as the source output, with the
 * repeated elements.
 */
TEST_P(QuickSortParamTest, MR29) {
    ...
    /* Construct expected follow-up output */
    vector<int> expected_follow_out;
    for (int i : source_out) {
        for (int j = 0; j < num_repeats; ++j) {
            expected_follow_out.push_back(i);
        }
    }
...
/**
 * @brief Metamorphic Relation 30: Swapping the first and last elements of the input array, the output array will have the same relative order as the source
 * output, with the two elements swapped.
 */
...
/**
 * @brief Metamorphic Relation 31: Replacing all elements of the input array with a single constant value, the output array will have the same relative order as
 * the source output, with all elements equal to the constant value.
 */
...
/**
 * @brief Metamorphic Relation 34: Randomly shuffling the elements in the input array, the output array will have the same relative order as the source output,
 * regardless of the shuffling.
 */
...
/**
 * @brief Metamorphic Relation 37: Sorting the input array in ascending order, then applying a cyclic permutation to the array, the output will have the same
 * relative order as the source output, just shifted.
 */
...
/**
 * @brief Metamorphic Relation 39: Sorting the input array and then appending the sorted array with a decreasing sequence, the output array will be sorted in
 * ascending order, with the decreasing sequence appended at the end.
 */
...
/**
 * @brief Metamorphic Relation 40: Replacing each element in the input array by the negative of its value, the output array will be in reverse order to the
 * source output.
 */
...
/**
 * @brief Metamorphic Relation 41: Sorting the input array and then replacing all elements with the maximum value, the output array will have every element
 * equal to the maximum value, as the array will be sorted.
 */
...
/**
 * @brief Metamorphic Relation 42: Sorting the input array and then appending the sorted array with an increasing sequence, the output array will have the same
 * relative order as the source output, with the increasing sequence appended at the end.
 */
...
/**
 * @brief Metamorphic Relation 44: Appending the input array with a duplicate of itself, the output array will have the same relative order as the source
 * output, with the duplicate elements appearing after their original counterparts.
 */
