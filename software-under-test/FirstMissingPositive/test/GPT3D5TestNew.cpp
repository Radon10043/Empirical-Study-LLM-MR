...
TEST_P(FMPInputParamTest, MR13) {
    ...
    /* Construct follow-up input */
    vector<int> follow_vec = source_vec;
    follow_vec.erase(remove_if(follow_vec.begin(), follow_vec.end(),
                              [](int x) { return x > 0; }), follow_vec.end());  // Remove positive integers
...
TEST_P(FMPInputParamTest, MR15) {
    ...
    vector<int> follow_vec = source_vec;
    follow_vec.erase(remove_if(follow_vec.begin(), follow_vec.end(),
                              [](int x) { return x <= 0; }), follow_vec.end());  // Remove non-positive elements
