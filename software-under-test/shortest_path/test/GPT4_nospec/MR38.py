...
class TestingClass(unittest.TestCase):
    ...
    def test38(self, efgraph: list, source: int, desst: int, method: str):  # Fixed
        ...
        original_distances = {(n1, n2): shortest_path(efgraph, method=method)[n1][n2] for n1 in range(len(efgraph)) for n2 in range(len(efgraph)) if n1 != n2}
        ...
        reversed_distances = {(n2, n1): shortest_path(reversed_graph, method=method)[n2][n1] for n1 in range(len(reversed_graph)) for n2 in range(len(reversed_graph)) if n1 != n2}
